...
router.get('/sub-admin/dashboard/details', async (req, res) => {
    if (req.session.user) {
        ...
        const sql16 = "SELECT  COUNT(*) as no, sum(product_price*order_items.quantity) as price FROM  product INNER JOIN order_items ON product.product_id = order_items.product_id INNER JOIN orders ON orders.id = order_items.order_id INNER JOIN payments ON payments.order_id = orders.id  INNER JOIN order_sub_admin ON orders.id = order_sub_admin.order_id   where orders.order_date = DATE_SUB(CURDATE(), INTERVAL +1 DAY) and payments.payment_status = 'pending' and  order_sub_admin.sub_admin_id = ?;";
        const sql17 = "SELECT  COUNT(*) as no, sum(product_price*order_items.quantity) as price FROM  product INNER JOIN order_items ON product.product_id = order_items.product_id INNER JOIN orders ON orders.id = order_items.order_id INNER JOIN payments ON payments.order_id = orders.id  INNER JOIN order_sub_admin ON orders.id = order_sub_admin.order_id   where orders.order_date = DATE_SUB(CURDATE(), INTERVAL +2 DAY) and payments.payment_status = 'pending' and  order_sub_admin.sub_admin_id = ?;";
        const sql18 = "SELECT  COUNT(*) as no, sum(product_price*order_items.quantity) as price FROM  product INNER JOIN order_items ON product.product_id = order_items.product_id INNER JOIN orders ON orders.id = order_items.order_id INNER JOIN payments ON payments.order_id = orders.id  INNER JOIN order_sub_admin ON orders.id = order_sub_admin.order_id   where orders.order_date = DATE_SUB(CURDATE(), INTERVAL +3 DAY) and payments.payment_status = 'pending' and  order_sub_admin.sub_admin_id = ?;";
        const sql19 = "SELECT  COUNT(*) as no, sum(product_price*order_items.quantity) as price FROM  product INNER JOIN order_items ON product.product_id = order_items.product_id INNER JOIN orders ON orders.id = order_items.order_id INNER JOIN payments ON payments.order_id = orders.id  INNER JOIN order_sub_admin ON orders.id = order_sub_admin.order_id   where orders.order_date = DATE_SUB(CURDATE(), INTERVAL +4 DAY) and payments.payment_status = 'pending' and  order_sub_admin.sub_admin_id = ?;";
        const sql20 = "SELECT  COUNT(*) as no, sum(product_price*order_items.quantity) as price FROM  product INNER JOIN order_items ON product.product_id = order_items.product_id INNER JOIN orders ON orders.id = order_items.order_id INNER JOIN payments ON payments.order_id = orders.id  INNER JOIN order_sub_admin ON orders.id = order_sub_admin.order_id   where orders.order_date = DATE_SUB(CURDATE(), INTERVAL +5 DAY) and payments.payment_status = 'pending' and  order_sub_admin.sub_admin_id = ?;";;
        const sql21 = "SELECT  COUNT(*) as no, sum(product_price*order_items.quantity) as price FROM  product INNER JOIN order_items ON product.product_id = order_items.product_id INNER JOIN orders ON orders.id = order_items.order_id INNER JOIN payments ON payments.order_id = orders.id  INNER JOIN order_sub_admin ON orders.id = order_sub_admin.order_id   where orders.order_date = DATE_SUB(CURDATE(), INTERVAL +6 DAY) and payments.payment_status = 'pending' and  order_sub_admin.sub_admin_id = ?;";
