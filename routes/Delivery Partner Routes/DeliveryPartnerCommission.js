...
router.get('/superadmin/delivery-partner-commissions', (req, res) => {
    if (req.session.user) {
        const user_id = req.session.user.id
        const sql1 = "SELECT * from delivery_partner_services;";
...
// Deliver partner own commission
router.get('/superadmin/own/delivery-partner-commissions', (req, res) => {
    if (req.session.user) {
        const user_id = req.session.user.id
        const sql1 = "SELECT * from delivery_partner_commision where partner_id = ?;";
